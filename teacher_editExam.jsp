                    ...
                    <div class="login-form-body">
                    	<div class="form-gp" >
	                   		<select name="course" class="form-control" id="course">
							    ...
							    <option value="1" <c:if test="${question.courseId== 1}"> selected </c:if>>Java Programming</option>
							    <option value="2" <c:if test="${question.courseId == 2}"> selected </c:if>>Operating System</option>
							    <option value="3" <c:if test="${question.courseId == 3}"> selected </c:if>>Web Programming</option>
							    <option value="4" <c:if test="${question.courseId == 4}"> selected </c:if>>Machine Learning</option>
							    
							</select>
	                   	</div>
                        <div class="form-gp">
                            <label for="exampleInputName1">Question</label>
                            <input type="text" id="exampleInputName1" name="question" value="<c:out value='${question.question}' />">
                            <i class="ti-user"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Answer 1</label>
                            <input type="text" id="exampleInputName1" name="answer_1" value="<c:out value='${question.answer1}' />">
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Answer 2</label>
                            <input type="text" id="exampleInputName1" name="answer_2" value="<c:out value='${question.answer2}' />">
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Answer 3</label>
                            <input type="text" id="exampleInputName1" name="answer_3" value="<c:out value='${question.answer3}' />">
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Answer 4</label>
                            <input type="text" id="exampleInputName1" name="answer_4" value="<c:out value='${question.answer4}' />">
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Correct Answer </label>
                            <input type="text" id="exampleInputName1" name="correct_answer" value="<c:out value='${question.correctAnswer}' />">
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
