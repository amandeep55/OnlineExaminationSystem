                ...
                <form action="CheckAnswer" method="post">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputName1" name="roll_number">
                            <i class="ti-user"></i>
                            <div class="text-danger"></div>
                        </div>
                        
                        <div class="form-gp">
                            <label for="exampleInputName1">Theory Result </label>
                            <input type="text" id="exampleInputName1" name="theory_result">
                            <i class="ti-user"></i>
                            <div class="text-danger"></div>
                        </div>
