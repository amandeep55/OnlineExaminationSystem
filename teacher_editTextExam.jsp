        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
              ...
              <div class="login-box ptb--100"> 
                <form action="TextQuestion" method="post">
                    ...
                    <div class="login-form-body">
                    	<div class="form-gp" >
	                   		...
	                   		<select name="department" class="form-control" id="dept">
							    ...
							    <option value="1" <c:if test="${question.departmentId== 1}"> selected </c:if>>IT</option>
							    <option value="2" <c:if test="${question.departmentId== 2}"> selected </c:if>>Computer Science</option>
