                ...
                <div class="menu-inner">
                    <nav>
                       <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="teacher_createTextExam.jsp"><i class="ti-receipt"></i> <span>Create Text Exam </span></a></li>
