                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="teacher_viewTextExam.jsp"><i class="ti-receipt"></i> <span>View Text Exam Questions</span></a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="u" items="${listTextQuestion}">
                                               		<tr>
                                                    
	                                                    <td><c:out value="${u.question}" /></td>
	                                                    <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li class="mr-3"><a href="TextQuestion?param=update&id=<c:out value='${u.id}' />" class="text-secondary"><i class="fa fa-edit"></i></a></li>
                                                            <li><a href="TextQuestion?param=delete&id=<c:out value='${u.id}' />" class="text-danger"><i class="ti-trash"></i></a></li>
                                                        </ul>
                                                    </td> 
                                                    </tr> 
