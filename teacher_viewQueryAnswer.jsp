                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="teacher_checkAnswers.jsp"><i class="ti-receipt"></i> <span>Check Answers</span></a></li>
                         	...
                         	<li class="active"><a href="teacher_viewQueryAnswer.jsp"><i class="ti-receipt"></i> <span>View Query </span></a></li>
                ...
                <form action="Query" method="post">
                    ...
                    <div class="login-form-body">
                       ...
                       <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="viewT">Submit <i class="ti-arrow-right"></i></button>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="u" items="${listTextQuestion}">
                                               		<tr>
	                                                    ...
	                                                    <td><c:out value="${u.answer}" /></td>
	                                                    <td><a href="Query?param=update&id=<c:out value='${u.id}' />" >Reply</i></a></td>
