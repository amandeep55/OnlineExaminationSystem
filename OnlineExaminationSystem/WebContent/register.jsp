                ...
                <form action="Register" method="post">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputPassword1" name="roll">
                            <i class="ti-"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">University</label>
                            <input type="text" id="exampleInputPassword1" name="university">
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
	                   		<select name="role" class="form-control" id="company">
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Don't have an account? <a href="login.jsp">Sign in</a></p>
                        </div>
                    </div>
                </form>
            </div>
